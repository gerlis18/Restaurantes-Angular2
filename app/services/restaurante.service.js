        ...
        execute: function() {
            RestauranteService = (function () {
                ...
                RestauranteService.prototype.getRestaurantes = function () {
                    return this._http.get('http://localhost:8080/slim-api/restaurantes-api.php/restaurantes').map(function (res) { return res.json(); });
                };
                RestauranteService.prototype.getRestaurante = function (id) {
                    return this._http.get('http://localhost:8080/slim-api/restaurantes-api.php/restaurante/' + id).map(function (res) { return res.json(); });
                };
                RestauranteService.prototype.addRestaurante = function (restaurante) {
                    var json = JSON.stringify(restaurante);
                    var params = "json=" + json;
                    var headers = new http_1.Headers({ "Content-Type": "application/x-www-form-urlencoded" });
                    return this._http.post('http://localhost:8080/slim-api/restaurantes-api.php/restaurantes', params, { headers: headers }).map(function (res) { return res.json(); });
                };
